...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className={`${inter.variable} ${barlow.variable}`}><TooltipProvider delayDuration={250}><DemoAuthProvider>{children}</DemoAuthProvider><Toaster richColors position="top-right" /></TooltipProvider></body></html>;
}
