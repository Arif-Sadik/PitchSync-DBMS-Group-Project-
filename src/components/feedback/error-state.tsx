...
export function ErrorState({ title = "Unable to display records", message = "The requested information could not be prepared. Please try again.", compact = false }: { title?: string; message?: string; compact?: boolean }) {
