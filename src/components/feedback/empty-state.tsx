...
export function EmptyState({ title = "No records found", description = "No information is available for this view.", icon: Icon = Inbox, action, compact = false }: { title?: string; description?: string; icon?: LucideIcon; action?: React.ReactNode; compact?: boolean }) {
