...
export function DataTableShell({ columns, emptyTitle = "No records found", emptyDescription = "No information is available for this view.", minWidth = 760 }: { columns: readonly string[]; emptyTitle?: string; emptyDescription?: string; minWidth?: number }) {
