...
export const roles: readonly RoleDefinition[] = [
  { id: "super-admin", label: "Super Administrator", shortLabel: "System Administration", description: "Oversee platform access, core records, and administrative readiness.", dashboardRoute: "/super-admin/dashboard", accent: "#006A4E", accentHover: "#005840", accentSoft: "#E4F0EA", icon: ShieldCheck },
  ...
  { id: "performance-manager", label: "Team Performance Manager", shortLabel: "Team Performance", description: "Review readiness, fitness, training, and selection information.", dashboardRoute: "/performance/dashboard", accent: "#006A4E", accentHover: "#005840", accentSoft: "#E4F0EA", icon: UsersRound },
  ...
  { id: "player", label: "Player", shortLabel: "Player Workspace", description: "View personal performance, availability, and schedule areas.", dashboardRoute: "/player/dashboard", accent: "#006A4E", accentHover: "#005840", accentSoft: "#E4F0EA", icon: UserRound },
] as const;
